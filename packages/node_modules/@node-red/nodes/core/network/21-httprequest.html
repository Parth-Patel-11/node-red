...
<script type="text/html" data-template-name="http request">
    ...
    <div class="form-row">
        <label for="node-input-retry"><span data-i18n="httpin.label.retry"></span></label>
        <input id="node-input-retry" type="number" placeholder="0">
    </div>
...
(function() {
    ...
    RED.nodes.registerType('http request',{
        ...
        oneditprepare: function() {
            ...
            $("#node-input-retry").val(parseInt(node?.retry || "0", 10));
        ...
        oneditsave: function() {
            ...
            const retryVal = parseInt($("#node-input-retry").val(), 10) || 0;
            node.retry = retryVal;
